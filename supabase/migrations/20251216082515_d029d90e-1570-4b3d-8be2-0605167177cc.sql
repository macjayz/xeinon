-- Temporarily replace the function to allow priced->discovered downgrade
...
BEGIN
  ...
  -- TEMPORARILY ALLOW priced->discovered downgrade for data fix
  IF OLD.token_stage = 'priced' AND NEW.token_stage = 'discovered' THEN
    RETURN NEW;
  END IF;
